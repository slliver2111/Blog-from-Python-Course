...
class Comment(db.Model, UserMixin):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    text: Mapped[str] = mapped_column(String(1000), unique=True)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        # Generate hashed and salted password for the user
        hashed_salted = generate_password_hash(password, method="pbkdf2:sha256", salt_length=8)
        ...
        new_user = User(email=email, password=hashed_salted, name=name)
